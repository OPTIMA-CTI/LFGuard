...
from .nets import FED_EMNISTCNN
from .nets import TrafficSignNet
...
class Arguments:
    ...
    def __init__(self, logger):
        ...
        if dataSetPath=="fed-mnist":
            self.net= FED_EMNISTCNN
        elif dataSetPath == "gts":
            self.net = TrafficSignNet
        else:
            self.net = FashionMNISTCNN 

        self.train_data_loader_pickle_path = "data_loaders/"+dataSetPath+"/train_data_loader.pickle"
        self.test_data_loader_pickle_path = "data_loaders/"+dataSetPath+"/test_data_loader.pickle"
