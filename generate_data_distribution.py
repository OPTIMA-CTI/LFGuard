...
from federated_learning.datasets import EDMnist
...
if __name__ == '__main__':
    ...
    # ----------- E-MNIST -------------
    # ---------------------------------       
    # dataset = EMNISTDataset(args)
    # TRAIN_DATA_LOADER_FILE_PATH = "data_loaders/e-mnist/train_data_loader.pickle"
    # TEST_DATA_LOADER_FILE_PATH = "data_loaders/e-mnist/test_data_loader.pickle"

    # if not os.path.exists("data_loaders/e-mnist"):
    #     pathlib.Path("data_loaders/e-mnist").mkdir(parents=True, exist_ok=True)
